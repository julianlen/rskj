...
public class Web3ImplTest {
    ...
    public void getUnknownTransactionReceipt() throws Exception {
        ...
        Assert.assertNull(web3.eth_getRawTransactionReceiptByHash(hashString));
    }
    ...
    public void getTransactionReceipt() throws Exception {
        ...
        String rawTransactionReceipt = web3.eth_getRawTransactionReceiptByHash(hashString);
        ...
        String[] transactionReceiptNodes = web3.eth_getTransactionReceiptNodesByHash(blockHashString, hashString);
    ...
    public void getBlockByNumberRetrieveEarliestBlock() throws Exception {
        ...
        String hexString = web3.eth_getRawBlockHeaderByNumber(bnOrId).replace("0x","");
    ...
    public void getBlockByNumberBlockDoesNotExists() throws Exception {
        ...
        String hexString = web3.eth_getRawBlockHeaderByNumber(bnOrId);
    ...
    public void getBlockByHash() throws Exception {
        ...
        String hexString = web3.eth_getRawBlockHeaderByHash(block1bHashString).replace("0x","");
        ...
        hexString = web3.eth_getRawBlockHeaderByHash(block2bHashString).replace("0x","");
    ...
    public void getBlockByHashBlockDoesNotExists() throws Exception {
        ...
        String hexString = web3.eth_getRawBlockHeaderByNumber(blockHash);
        Assert.assertNull(hexString);
    }
